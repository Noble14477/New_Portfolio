...
import { FiArrowLeft, FiCalendar, FiClock, FiShare2, FiTwitter, FiLinkedin, FiBookmark } from "react-icons/fi";
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        >
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <ReactMarkdown
              ...
              components={{
                // eslint-disable-next-line no-unused-vars
                h2: ({node, ...props}) => <h2 className="text-2xl font-bold mt-12 mb-6 text-gray-900 dark:text-white" {...props} />,
                h3: ({node, ...props}) => <h3 className="text-xl font-bold mt-10 mb-4 text-gray-900 dark:text-white" {...props} />,
                p: ({node, ...props}) => <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6" {...props} />,
                ul: ({node, ...props}) => <ul className="list-disc pl-6 mb-6 space-y-2" {...props} />,
                ol: ({node, ...props}) => <ol className="list-decimal pl-6 mb-6 space-y-2" {...props} />,
                li: ({node, ...props}) => <li className="text-gray-700 dark:text-gray-300" {...props} />,
                blockquote: ({node, ...props}) => (
                  <blockquote className="border-l-4 border-tertiary pl-4 italic text-gray-600 dark:text-gray-400 my-6" {...props} />
                ),
                table: ({node, ...props}) => (
                ...
                code: ({node, inline, ...props}) => {
                  if (inline) {
                    return <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded text-sm" {...props} />
                  }
                  return (
                ...
                img: ({node, ...props}) => (
                  <img className="rounded-lg shadow-md my-6 mx-auto" {...props} />
                )
              }}
            >
              {post.content}
          ...
          <div className="mt-16 p-6 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-start">
            ...
            />
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white">Noble Chinonso</h3>
              <p className="text-gray-600 dark:text-gray-300 mt-1">
                Web Developer & Designer | Creator of NobleDevWorks | Tech Educator
              </p>
              <div className="flex space-x-4 mt-3">
                <a href="#" className="text-gray-500 hover:text-tertiary transition-colors">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Share this post</h3>
        ...
        <section className="mt-20 bg-gradient-to-r from-tertiary to-tertiary-dark rounded-xl p-8 text-white">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4">Stay updated with my latest posts</h2>
            <p className="mb-6 opacity-90">
              Join my newsletter to receive web development tips, design insights, and tech education content.
            </p>
