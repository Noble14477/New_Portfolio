        ...
        <Parallax speed={10} className="w-full">
          <div className="flex flex-col justify-center items-center">
            <div className="relative flex justify-center items-center flex-col mb-4">
              <h2 className="text-4xl capitalize font-serif font-bold py-6">
                About Me.
              </h2>
              <div className="bg-tertiary w-[40px] h-2 rounded-full" />
            </div>
            <p className="text-[17px] max-w-3xl leading-[30px] mt-4 text-center">
              Learn more about who I am, what I do, and the range of skills I
              bring to the table—from design to development and training.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 md:gap-20 mt-20">
            ...
            <div className="flex flex-col">
              ...
              <h3 className="pb-8 text-2xl font-bold font-serif">
                Get To Know Me!
              </h3>

              <div>
                <p className="text-[16px] text-gray-900 dark:text-white leading-7">
                  I'm a <b>multi-skilled creative professional</b> specializing
                  in <b>web development</b>, <b>graphic design</b>, and{" "}
                  ...
                  <br />
                  <br />I began my journey with graphic design, where I
                  developed a strong eye for structure and color. Over time, I
                  transitioned into frontend development and expanded into
                  offering training, project planning, and working with tools
                  like <b>Firebase, MongoDB, Cloudinary</b>, and animation
                  libraries such as <b>Framer Motion</b>.
                </p>
                ...
                <p className="text-[16px] text-gray-900 dark:text-white leading-7">
                  ...
                  <ul className="list-disc ml-6 mt-2">
                    ...
                    <li>
                      🚀 Digital support for small businesses and startups
                    </li>
                  </ul>
                  <br />I also share useful insights on{" "}
                  <a
                  ...
                  <br />
                  I'm open to{" "}
                  <b>freelance gigs, collaborations, teaching opportunities</b>,
                  and <b>remote/full-time roles</b>. If you're looking for
                  someone who understands design, code, and impact—let's
                  connect.
                </p>
